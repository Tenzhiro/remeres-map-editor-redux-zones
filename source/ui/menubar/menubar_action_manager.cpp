...
#define MAKE_SET_ACTION(id, kind, setting_, handler)                                                                \
	...
	MAKE_ACTION_ICON(SEARCH_ON_MAP_ZONES, wxITEM_NORMAL, ICON_SEARCH, OnSearchForZonesOnMap);
	...
	MAKE_ACTION_ICON(SEARCH_ON_SELECTION_ZONES, wxITEM_NORMAL, ICON_SEARCH, OnSearchForZonesOnSelection);
	...
	MAKE_ACTION_ICON(SHOW_ZONE_AREAS, wxITEM_CHECK, ICON_MAP, OnChangeViewSettings);
